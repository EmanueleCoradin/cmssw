...
layers = [
    ...
    [    28,     True,  1.00,   0.005,   99.0, 8.16e-02, 8.32e-04, 0.99999],
    [    29,     True,  1.00,   0.005,   99.0, 4.82e-02, 4.27e-04, 0.99999],
    [    30,     True,  1.00,   0.004,   99.0, 3.79e-02, 2.76e-04, 0.99999],
    [    31,    False,  1.00,   0.010,   99.0, 1.00e-3,  1.00e-05, 0.999999],
    [    32,    False,  1.00,   0.009,   99.0, 1.00e-3,  1.00e-05, 0.999999],
    [    33,    False,  1.00,   0.009,   99.0, 1.00e-3,  1.00e-05, 0.999999],
    [    34,    False,  1.00,   0.009,   99.0, 1.00e-3,  1.00e-05, 0.999999],
    [    35,    False,  1.00,   0.009,   99.0, 1.00e-3,  1.00e-05, 0.999999],
    [    36,    False,  1.00,   0.010,   99.0, 1.00e-3,  1.00e-05, 0.999999],
    [    37,    False,  1.00,   0.009,   99.0, 1.00e-3,  1.00e-05, 0.999999],
    [    38,    False,  1.00,   0.009,   99.0, 1.00e-3,  1.00e-05, 0.999999],
    [    39,    False,  1.00,   0.009,   99.0, 1.00e-3,  1.00e-05, 0.999999],
    [    40,    False,  1.00,   0.009,   99.0, 1.00e-3,  1.00e-05, 0.999999],
]
...
# forward TID
    [ 28, 31, False, False,   1100,   70.0,   130.,    20.0,    41.0,  18.0,    5.0,   80.0,  0.85], 
    [ 29, 31, False, False,   1100,   70.0,   130.,    35.0,    60.0,  24.0,    5.0,   55.0,  0.85],
    [ 30, 31, False, False,   1100,   100.,   130.,    55.0,    70.0,  14.0,   10.0,   30.0,  0.85],
    
    [ 31, 32, False, False,   1100,   23.0,   60.0,    25.0,    70.0,  14.0,   15.0,   30.0,  0.85],
    [ 32, 33, False, False,   1100,   25.0,   55.0,    30.0,    70.0,  14.0,   20.0,   40.0,  0.85],
    [ 33, 34, False, False,   1100,   30.0,   55.0,    35.0,    70.0,  12.0,   30.0,   50.0,  0.85],
    [ 34, 35, False, False,   1100,   30.0,   55.0,    35.0,    70.0,  12.0,   35.0,   60.0,  0.85],
    
    [  9, 31, False, False,    750,   10.0,   18.0,    20.0,    28.0,  10.0,   40.0,   50.0,  0.85],
    [  9, 32, False, False,   1000,   10.0,   18.0,    20.0,    30.0,  15.0,   65.0,   75.0,  0.85],
# backward TID
    [ 28, 36, False, False,   1100,  -130.,  -70.0,    20.0,    41.0,  18.0,  -80.0,   -5.0,  0.85], 
    [ 29, 36, False, False,   1100,  -130.,  -70.0,    35.0,    60.0,  24.0,  -55.0,   -5.0,  0.85],
    [ 30, 36, False, False,   1100,  -130.,  -100.,    55.0,    70.0,  14.0,  -30.0,  -10.0,  0.85],
    
    [ 36, 37, False, False,   1100,   23.0,   60.0,    25.0,    70.0,  14.0,  -30.0,  -15.0,  0.85],
    [ 37, 38, False, False,   1100,   25.0,   55.0,    30.0,    70.0,  14.0,  -40.0,  -20.0,  0.85],
    [ 38, 39, False, False,   1100,   30.0,   55.0,    35.0,    70.0,  12.0,  -50.0,  -30.0,  0.85],
    [ 39, 40, False, False,   1100,   30.0,   55.0,    35.0,    70.0,  12.0,  -60.0,  -35.0,  0.85],
    
    [ 21, 36, False, False,    750,   10.0,   18.0,    20.0,    28.0,  10.0,  -50.0,  -40.0,  0.85],
    [ 21, 37, False, False,   1000,   10.0,   18.0,    20.0,    30.0,  15.0,  -75.0,  -65.0,  0.85],
]
