...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  namespace portabletest {
    ...
    using SimpleNetFP16DeviceCollection = PortableCollection<SimpleNetFP16SoA>;
...
ASSERT_DEVICE_MATCHES_HOST_COLLECTION(portabletest::SimpleNetFP16DeviceCollection,
                                      portabletest::SimpleNetFP16HostCollection);
