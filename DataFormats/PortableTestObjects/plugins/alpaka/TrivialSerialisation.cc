...
DEFINE_TRIVIAL_SERIALISER_PLUGIN_DEVICE(portabletest::HitToTrackDeviceCollection);
DEFINE_TRIVIAL_SERIALISER_PLUGIN_DEVICE(portabletest::TrackBeginDeviceCollection);
