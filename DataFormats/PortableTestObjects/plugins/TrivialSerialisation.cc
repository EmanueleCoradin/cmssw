...
DEFINE_TRIVIAL_SERIALISER_PLUGIN(portabletest::HitHostCollection);
DEFINE_TRIVIAL_SERIALISER_PLUGIN(portabletest::HitToTrackHostCollection);
DEFINE_TRIVIAL_SERIALISER_PLUGIN(portabletest::TrackBeginHostCollection);
